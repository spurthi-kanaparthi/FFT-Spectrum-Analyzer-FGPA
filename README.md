...
│
├── fft_top.v
│   Top-level Verilog module that interfaces with the Xilinx FFT IP core.
│
├── fft_tb.v
│   Testbench used to simulate the FFT design and feed input samples.
│
├── xfft_0.xci
│   Xilinx FFT IP core configuration file generated by Vivado.
│
├── fft_project.m
│   MATLAB script used to generate the input signal and analyze FFT output.
│
├── input_signal.txt
│   Input signal samples generated in MATLAB and used for simulation.
│
├── fft_output.txt
│   FFT output values generated after simulation in Vivado.
│
└── README.md
...
3. Simulation generates fft_output.txt.
4. MATLAB reads fft_output.txt and plots the frequency spectrum.
...
### MATLAB Spectrum
![MATLAB Spectrum](matlab_spectrum.png)

### FPGA FFT Output
![FFT Output](fft_output.png)
